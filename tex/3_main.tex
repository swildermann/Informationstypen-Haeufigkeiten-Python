...
Diese Entscheidung führte dazu, dass wir die Typisierungen überhaupt anhand von Markierungen durchführen konnten (siehe Kapitel \ref{sec:Markierungen}).
...
Für die Umsetzung der genannten Anforderungen wurde das Webframework "`Django"' verwendet - da es auf Python basiert und eine große Gemeinschaft gibt, die im Zweifel bei Herausforderungen unterstützten können. 

\subsubsection{Ergebnis}
\begin{figure}[h!] 
\centering
\includegraphics[width=1.1\textwidth]{pictures/1898.png}
\caption[Anzeige einer Dokumentationseinheit mit Markierungen]{Anzeige einer Dokumentationseinheit mit Markierungen}
\label{fig:1898}
\end{figure}
