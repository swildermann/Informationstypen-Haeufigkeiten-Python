...
% PDF settings
\usepackage[pdfstartview=FitH,pdftitle={Messung der Informationstypen-Häufigkeiten in der Python-Dokumentation },pdfauthor={Sven Wildermann}, colorlinks=false, linktocpage, pdfborder={0 0 0 }]{hyperref}
